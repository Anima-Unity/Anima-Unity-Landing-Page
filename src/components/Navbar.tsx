...
export default function Navbar() {
  ...
  const isMinimal = ['/privacy-policy', '/terms-of-service', '/cookie-policy', '/blog', '/blog/admin', '/help-center', '/help-center/contact-support', '/shelter-network'].includes(pathname)
