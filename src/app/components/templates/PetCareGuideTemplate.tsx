...
const GuideCard: React.FC<GuideCardProps> = ({ title, description, icon, category, color, bgColor }) => {
  return (
    <div className="bg-white rounded-2xl shadow-card hover:shadow-card-hover transition-shadow p-6 border border-gray-100">
      <div className={`w-12 h-12 flex items-center justify-center rounded-lg mb-4 ${color}`}>
        <span className="text-white text-xl">{icon}</span>
      </div>
      <span className={`text-sm font-medium ${bgColor} px-2 py-1 rounded-md mb-2 inline-block`}>{category}</span>
...
const FeaturedGuide: React.FC<FeaturedGuideProps> = ({ title, description, image, author, date }) => {
  return (
    <div className="bg-white rounded-2xl shadow-card hover:shadow-card-hover transition-all duration-300 overflow-hidden border border-gray-100">
      ...
      <div className="p-6 bg-card-gradient">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="md:w-1/2 mb-8 md:mb-0">
                ...
                <div className="flex space-x-4">
                  <button className="bg-primary text-white px-6 py-3 rounded-lg font-medium hover:bg-primary-dark transition shadow-button hover:shadow-button-hover">
                    Browse All Guides
                  </button>
              ...
              <div className="md:w-1/2 relative">
                <div className="bg-feature-healthcare rounded-3xl p-8 relative z-10">
                  <div className="bg-white rounded-2xl shadow-card p-6">
                    <div className="flex items-center space-x-4 mb-6">
                      <div className="w-12 h-12 bg-feature-healthcare rounded-full flex items-center justify-center">
                    ...
                    <div className="flex items-center space-x-4 mb-6">
                      <div className="w-12 h-12 bg-feature-shelter rounded-full flex items-center justify-center">
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-feature-tracking rounded-full flex items-center justify-center">
                        <span className="text-2xl">🔄</span>
                      </div>
                      <div>
                ...
                <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-feature-healthcare rounded-full opacity-50"></div>
                <div className="absolute -top-6 -left-6 w-24 h-24 bg-feature-shelter rounded-full opacity-50"></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-3 font-display">Popular Guide Categories</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl shadow-card p-6 border border-gray-100 text-center hover:shadow-card-hover transition">
                <div className="w-16 h-16 bg-feature-shelter rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">🐶</span>
                </div>
                ...
                <Link 
                  href="#" 
                  className="text-primary font-medium inline-flex items-center justify-center hover:text-primary-dark"
                >
                  View guides
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              ...
              <div className="bg-white rounded-2xl shadow-card p-6 border border-gray-100 text-center hover:shadow-card-hover transition">
                <div className="w-16 h-16 bg-feature-healthcare rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">🐱</span>
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-card p-6 border border-gray-100 text-center hover:shadow-card-hover transition">
                <div className="w-16 h-16 bg-feature-telemedicine rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">❤️</span>
                </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-12">
              <h2 className="text-3xl font-bold font-display">Featured Guides</h2>
              <Link 
                href="#" 
                className="text-primary font-medium inline-flex items-center hover:text-primary-dark"
              >
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between mb-12">
              <h2 className="text-3xl font-bold font-display mb-4 md:mb-0">Latest Pet Care Guides</h2>
              <div className="flex space-x-2">
                <button className="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary-dark transition shadow-button">
                  All
                </button>
                <button className="bg-white text-gray-700 px-4 py-2 rounded-lg border border-gray-200 hover:bg-gray-50 transition">
                  Dogs
                </button>
                <button className="bg-white text-gray-700 px-4 py-2 rounded-lg border border-gray-200 hover:bg-gray-50 transition">
                  Cats
            ...
            <div className="mt-12 text-center">
              <button className="border border-gray-300 text-gray-700 px-6 py-3 rounded-lg font-medium hover:bg-gray-50 transition inline-flex items-center">
                Load More Guides
        ...
        <section className="py-16 bg-cta-gradient text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold mb-4 font-display">Stay Updated with Pet Care Tips</h2>
              ...
              <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                <input 
                  ...
                  className="px-4 py-3 rounded-lg flex-grow text-gray-800 focus:outline-none focus:ring-2 focus:ring-primary-light"
                />
                <button className="bg-white text-primary px-6 py-3 rounded-lg font-medium hover:bg-gray-100 transition shadow-button">
                  Subscribe
                </button>
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0">
                <div className="relative">
                  <div className="w-full h-64 md:h-96 bg-gray-200 rounded-3xl relative z-10 overflow-hidden shadow-app">
                    <Image
                      ...
                      width={1169}  // matches original image width
                      height={780}  // estimated height based on common aspect ratios
                      sizes="(max-width: 640px) 100vw, (max-width: 1024px) 80vw, 1169px"
                      priority  // equivalent to loading="eager" in Next.js Image
                    />
                  </div>
                  <div className="absolute -bottom-4 -right-4 w-40 h-40 bg-feature-healthcare rounded-2xl z-0"></div>
                </div>
              </div>
              <div className="md:w-1/2 md:pl-12">
                <h2 className="text-3xl font-bold mb-6 font-display">Created by Pet Care Experts</h2>
                ...
                <div className="flex flex-col space-y-4">
                  <div className="flex items-center">
                    <div className="w-8 h-8 bg-feature-tracking rounded-full flex items-center justify-center mr-3">
                ...
                <div className="mt-8">
                  <a 
                    href="#" 
                    className="bg-primary text-white px-6 py-3 rounded-lg font-medium hover:bg-primary-dark transition inline-block shadow-button hover:shadow-button-hover"
                  >
                    Meet Our Experts
                  </a>
                </div>
