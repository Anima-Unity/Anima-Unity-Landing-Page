...
export default function AnitrackGpsTemplate() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <Badge className="bg-orange-50 text-orange-600 text-xs font-medium px-2 py-1 rounded-md">Pet Safety Solution</Badge>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-6 leading-tight">
              Keep Your Pet Safe <span className="text-orange-500">Anywhere</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Button className="bg-orange-500 hover:bg-orange-600 rounded-full text-sm px-6 py-3">Get Started</Button>
              <Button variant="outline" className="border-gray-200 text-gray-600 hover:bg-gray-50 rounded-full text-sm px-6 py-3 flex items-center gap-2">
                ...
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M10 8L14 12L10 16" stroke="#F97316" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </Button>
            </div>
          </div>
          <div className="relative">
              ...
              <div className="p-4">
                ...
                <div className="mt-6 grid grid-cols-3 gap-4">
                  <div className="bg-orange-50 p-3 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="bg-orange-100 w-8 h-8 rounded-full flex items-center justify-center">
                        <IoLocationOutline className="w-4 h-4 text-orange-600" />
                      </div>
                  ...
                  <div className="bg-orange-50 p-3 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="bg-amber-100 w-8 h-8 rounded-full flex items-center justify-center">
                        <FaHistory className="w-3 h-3 text-amber-600" />
                      </div>
                  ...
                  <div className="bg-orange-50 p-3 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="bg-amber-100 w-8 h-8 rounded-full flex items-center justify-center">
                        <FaBell className="w-3 h-3 text-amber-600" />
                      </div>
            ...
            {/* Decorative elements */}
            <div className="absolute top-8 -left-4 bg-amber-100 rounded-lg p-3 shadow-md z-0">
              <div className="flex items-center gap-2">
                <div className="bg-white w-6 h-6 rounded-full flex items-center justify-center">
                  <FaPaw className="text-xs text-amber-600" />
                </div>
                <span className="text-xs font-medium text-gray-700">Safe Zone</span>
              </div>
            </div>
            
            <div className="absolute bottom-8 -left-4 bg-orange-100 rounded-lg p-3 shadow-md z-0">
              <div className="flex items-center gap-2">
                <div className="bg-white w-6 h-6 rounded-full flex items-center justify-center">
                  <IoLocationOutline className="text-xs text-orange-600" />
                </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <div className="mt-8">
              <Button className="bg-orange-500 hover:bg-orange-600 rounded-full text-sm px-5 py-2.5">
                Try it Free
              </Button>
            </div>
          </div>
      ...
      <section className="py-16 px-6 bg-orange-50">
        <div className="max-w-7xl mx-auto">
            ...
            {[
              ...
              <div key={index} className="flex flex-col items-center">
                <div className="flex items-center mb-4">
                  <div className="bg-white shadow-md rounded-full w-10 h-10 flex items-center justify-center text-orange-500 font-medium">
                    {item.step}
                  </div>
                  {index < 2 && (
                    <div className="hidden md:block h-0.5 w-24 bg-orange-200"></div>
                  )}
                </div>
          ...
          <div className="mt-16 flex justify-center">
            <Button className="bg-orange-500 hover:bg-orange-600 rounded-full text-sm px-6 py-3">
              Get Started Now
            </Button>
          </div>
        </div>
      ...
      {/* Trusted By Section */}
      <section className="py-12 px-6 border-y border-orange-100">
        <div className="max-w-7xl mx-auto">
      ...
      {/* CTA Section */}
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto bg-orange-500 rounded-2xl text-white p-10">
          <div className="text-center">
            ...
            <Button className="bg-white text-orange-600 hover:bg-orange-50 rounded-full text-sm px-6 py-3">
              Start Free Trial
            </Button>
          </div>
        </div>
