...
const blogPosts = [
  {
    ...
    content: `
      <p>Kucing lo suka tiba-tiba ngilang, terus balik lagi beberapa hari kemudian? Jangan khawatir, ini perilaku normal mereka! Mari kita bahas mengapa kucing suka hilang dari rumah:</p>

      <h2>1. Insting Berburu</h2>
      ...
      <h2>2. Teritorial dan Eksplorasi</h2>
      ...
      <p>Ingat, meskipun kucing adalah hewan peliharaan, mereka masih memiliki sifat liar dan kebutuhan untuk mengekspresikan perilaku alami mereka. Menghilang sesekali adalah bagian dari sifat mereka, jadi jangan terlalu khawatir jika kucing kamu sehat dan biasanya pulang lagi!</p>
    `,
    readTime: '5 min',
  ...
  },
  {
    ...
    cover: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?q=80&w=1143&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    content: `
      <p>Kucing yang sakit membutuhkan perhatian dan perawatan khusus. Berikut adalah 7 tips merawat kucing yang sedang sakit:</p>

      <h2>1. Perhatikan Tanda-tanda Penyakit</h2>
      ...
      <h2>2. Sediakan Tempat Nyaman</h2>
      ...
      <h2>4. Pemberian Obat yang Tepat</h2>
      ...
      <h2>6. Bantu dengan Kebersihan</h2>
      ...
      <h2>7. Berikan Banyak Kasih Sayang</h2>
      ...
      <p>Ingat, meskipun tips ini dapat membantu, tidak ada yang menggantikan perawatan profesional. Jika kucing menunjukkan tanda-tanda sakit yang berlanjut lebih dari 24 jam atau kondisi yang memburuk dengan cepat, segera bawa ke dokter hewan.</p>
    `,
    readTime: '4 min',
  ...
  },
  {
    ...
    cover: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?q=80&w=1143&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    content: `
      <p>Mengadopsi anak kucing adalah hal yang menggembirakan, tapi juga tanggung jawab besar. Berikut panduan adopsi anak kucing secara etis dan bertanggung jawab:</p>

      <h2>1. Pertimbangkan Kesiapan</h2>
      ...
      <h2>2. Adopsi dari Shelter atau Rescue Group</h2>
      ...
      <h2>3. Pilih Kucing yang Cocok</h2>
      ...
      <h2>5. Pertemuan Pertama dengan Hewan Lain</h2>
      ...
      <h2>6. Jadwalkan Pemeriksaan Dokter Hewan</h2>
      ...
      <h2>7. Beri Waktu untuk Adaptasi</h2>
      ...
      <p>Mengadopsi kucing adalah pengalaman yang memuaskan. Dengan persiapan yang tepat dan pendekatan yang bertanggung jawab, kamu bisa memberi rumah yang penuh kasih sayang untuk teman berbulu baru dan mendapatkan teman seumur hidup!</p>
    `,
    readTime: '6 min',
    ...
    <div className="bg-white">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <Link href="/blog" className="flex items-center text-red-500">
